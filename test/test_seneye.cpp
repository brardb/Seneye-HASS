/*
Copyright (c) <2021>, Benoit Brard <ben@brardb.net>
All rights reserved.
...
bool SeneyeMockDevice::Write(const unsigned char* data) {
  memcpy(buffer, data, 65);
  return is_successful;
}

bool SeneyeMockDevice::Read(unsigned char* data) {
  memcpy(data, buffer, 65);
  return is_successful;
}

constexpr unsigned char LIGHT_READING[65]{
...
constexpr unsigned char LIGHT_READING2[65]{
...
constexpr unsigned char SENSOR_READING[65]{
...
constexpr unsigned char SENSOR_READING2[65]{
...
constexpr unsigned char SENSOR_READING3[65]{
